      ...
      <div className="delivery-left-wrapper">
        ...
        <div className="delivery-left">
          ...
          <div className="delivery-left-second-part">
            ...
            <p>
              ექიმის მიერ გაცემული რეცეპტის გადამოწმება და რაოდენობების კონტროლი
              აფთიაქში.
            </p>
            <br />
            <br />
            ...
            <p>
              ექიმის გამოწერილი მედიკამენტების აპლიკაციიდანვე მიწოდება და
              ფასების შედარება.
            </p>
          </div>
        </div>
