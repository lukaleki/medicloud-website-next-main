      ...
      {isSlider && (
        <>
          <button onClick={handlePrev} id="prevBtn">
            <Image style={{rotate: '180deg'}} src={sliderArrow} width='10' height='8' alt='slider-arrow' className='slider-arrow' />
          </button>
          <button onClick={handleNext} id="nextBtn">
            <Image src={sliderArrow} width='10' height='8' alt='slider-arrow' className='slider-arrow' />
          </button>
        </>
      )}
    </div>
