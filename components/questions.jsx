    ...
    <section id='questions' className='questions'>
      ...
      <div id='contact' className="contact">
        <div className="contact-left">
          <Image className='clinic-map' src={clinicMap} width='632' height='551' alt='clinic-map'/> <div className="contact-line"></div> <h3>კონტაქტი</h3>
        </div>
        <div className="contact-right">
            ...
            <button><h2>გაგზავნა</h2><Image className='clinic-map' src={diagonalArrow} width='14' height='14' alt='clinic-map'/></button>  
        </div>
      </div>
    </section>
  )
